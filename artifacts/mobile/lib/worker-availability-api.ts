...
export function getWorkerAvailability() {
  return workerFetch<WorkerAvailabilityResponse>("/api/worker/availability");
}

export function updateAvailabilitySlots(slots: AvailabilitySlot[]) {
  return workerFetch<WorkerAvailabilityResponse>("/api/worker/availability/slots", {
    method: "PUT",
...
export function updateAvailabilityPreferences(max_shifts_per_week: number) {
  return workerFetch<WorkerAvailabilityResponse>("/api/worker/availability/preferences", {
    method: "PUT",
...
export function updateAvailabilityBlackouts(blackout_dates: BlackoutDate[]) {
  return workerFetch<WorkerAvailabilityResponse>("/api/worker/availability/blackouts", {
    method: "PUT",
...
export function setEmergencyAvailabilityOverride(target_date: string) {
  return workerFetch<WorkerAvailabilityResponse>("/api/worker/availability/emergency-override", {
    method: "POST",
