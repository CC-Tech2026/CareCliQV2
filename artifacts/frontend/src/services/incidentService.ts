...
export interface IncidentPayload {
  ...
  location?: string;
  witnesses?: string;
  support_workers_present?: string;
  other_persons_involved?: string;
  participant_harmed?: "yes" | "no" | "unknown";
  participant_impact?: string;
  worker_actions?: string;
  injury_nature?: string;
  injury_medical_attention?: "ambulance" | "hospital_self_transport" | "gp" | "none";
  emergency_services_called?: "triple_zero" | "sa_ambulance_only" | "no";
  family_notified?: "yes" | "not_yet" | "not_applicable";
  md_notified?: "yes" | "not_yet";
