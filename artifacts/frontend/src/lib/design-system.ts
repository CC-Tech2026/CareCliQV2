...
// ── Shadows ───────────────────────────────────────────────────────────────────
// Reuses the app's own --cc-shadow-* tokens (defined once in index.css,
// theme-aware) instead of a second, hardcoded neutral-navy shadow scale —
// there was no reason for two different shadow languages in the same app.
