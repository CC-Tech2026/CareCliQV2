...
/**
 * Shared accessibility settings UI — font size, theme, high contrast, dyslexia
 * font, language. Rendered both as its own page (worker-accessibility.tsx, for
 * a direct URL) and as a section inside Settings (settings.tsx), so the two
 * never drift apart.
 */
export function AccessibilityPanel({ showHeader = true }: { showHeader?: boolean }) {
