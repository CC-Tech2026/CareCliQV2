...
const PARENT_MAP: Array<{ prefix: string; parentHref: string; parentKey: string }> = [
  // Workflow pages under Sessions
  { prefix: "/session-new",            parentHref: "/sessions",               parentKey: "nav.sessions"          },
  { prefix: "/session-review",         parentHref: "/sessions",               parentKey: "nav.sessions"          },
  { prefix: "/sessions/",              parentHref: "/sessions",               parentKey: "nav.sessions"          },
