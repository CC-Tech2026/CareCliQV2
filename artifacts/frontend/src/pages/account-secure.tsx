    ...
    <div className="min-h-screen grid grid-cols-1 lg:grid-cols-12 bg-cc-bg">
      <div className="lg:col-span-5 flex flex-col justify-between p-6 sm:p-10 md:p-12 bg-cc-surface">
        <div className="flex items-center gap-3">
          ...
          <span className="text-[10px] font-bold uppercase tracking-[0.2em] text-cc-muted">Security</span>
        </div>
      ...
      <div className="hidden lg:flex lg:col-span-7 items-center justify-center p-12 relative overflow-hidden">
        ...
        <div className="relative z-10 max-w-lg rounded-[2rem] border border-white/30 bg-cc-surface/70 p-8 backdrop-blur-md">
          <h2 className="text-xl font-black text-cc-text">What happens next?</h2>
