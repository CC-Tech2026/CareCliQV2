  ...
  if (status === "draft" || (!score && !status)) {
    return (
      <span
        ...
        style={{ background: "rgba(84,34,105,0.06)", color: T3 }}
      >
        Draft
      </span>
    );
    ...
    <div className="bg-white rounded-2xl p-5" style={{ boxShadow: CARD_SHADOW }}>
      ...
      {loading ? (
        <div
          ...
          style={{ background: "rgba(232,213,232,0.4)" }}
        />
      ) : (
        <p
...
export default function Dashboard() {
  ...
  const missingNotes    = sessions.filter(
    s => !s.notes || (s.notes as string).trim().length < 30
  );
  ...
  return (
    <div className="space-y-5 max-w-5xl">
      ...
      <div className="flex items-start justify-between gap-4 pt-1">
        <div>
          <p className="text-[12px] font-medium mb-1" style={{ color: T3 }}>
            {format(now, "EEEE, d MMMM yyyy")}
          </p>
          <h1 className="text-[22px] font-bold tracking-tight leading-tight" style={{ color: T1 }}>
            ...
            {sessionsLoading
              ...
              : `${thisWeek.length} session${thisWeek.length !== 1 ? "s" : ""} this week`
                + (missingNotes.length > 0
                  ? ` · ${missingNotes.length} incomplete note${missingNotes.length !== 1 ? "s" : ""}`
                  : " · all notes complete")}
          </p>
        </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-5">
        ...
        {/* Recent sessions (spans 2 of 3 columns) */}
        <div
        ...
        >
          ...
          >
            <h2 className="text-[14px] font-semibold" style={{ color: T1 }}>
              Recent Sessions
            </h2>
            <Link href="/sessions">
              <button
          ...
          {sessionsLoading ? (
            <div className="divide-y" style={{ borderColor: BORDER }}>
              {Array(4).fill(0).map((_, i) => (
                <div key={i} className="flex items-center gap-4 px-5 py-4">
                  ...
                  />
                  <div
                    className="h-4 w-16 rounded-lg animate-pulse ml-auto"
                    style={{ background: "rgba(232,213,232,0.4)" }}
                  />
                </div>
              ))}
            ...
            <div className="px-5 py-12 text-center">
              ...
              <p className="text-[13px]" style={{ color: T3 }}>No sessions recorded yet</p>
              <Link href="/sessions/new">
                <button
            ...
            <div className="divide-y" style={{ borderColor: BORDER }}>
              {recentSessions.map((s) => {
                ...
                return (
                  <Link
                    key={s.id}
                    href={isLive ? `/sessions/${s.id}/live` : `/sessions/${s.id}`}
                  >
                        ...
                        >
                          ...
                          {isLive && (
                            <span
                              ...
                              style={{
                                background: "rgba(84,34,105,0.07)",
                                color: PLUM,
                              }}
                            >
                              <span
          ...
          >
            ...
            <div className="divide-y" style={{ borderColor: BORDER }}>
              {[
                ...
                { label: "All Sessions",       icon: Calendar,    href: "/sessions"     },
                ...
                <Link key={label} href={href}>
                  <div className="flex items-center gap-3 px-4 py-3 hover:bg-pink-50/40 transition-colors cursor-pointer">
                    ...
                    <span className="text-[13px] font-medium" style={{ color: T1 }}>
                      {label}
                    </span>
                ...
                <>
                  ...
                  <p className="text-[12px]" style={{ color: T3 }}>
                    {complianceScore >= 85
                      ...
                      : complianceScore >= 60
                      ? "Some sessions require attention"
            ...
            >
              ...
              <div className="divide-y" style={{ borderColor: BORDER }}>
                {(Array.isArray(alerts) ? alerts : [])
                  .slice(0, 3)
                  .map((alert: { id: string; message?: string }) => (
