...
function ModulesTab() {
  ...
  async function toggleFlag(module: CoordinatorTrainingModule, key: "auto_assign_on_hire" | "requires_certification") {
    ...
    try {
      const updated = await updateTrainingModule(module.id, { [key]: !module[key] });
  ...
  return (
    <div className="space-y-5">
      ...
      {loading ? (
        ...
        <div className="rounded-xl border p-10 text-center" style={{ borderColor: BORDER }}>
          <GraduationCap size={32} className="mx-auto mb-3" style={{ color: MUTED }} />
          <p className="font-black" style={{ color: TEXT }}>No training modules yet</p>
                ...
                <div className="min-w-0">
                  ...
                  <div className="mt-2 flex flex-wrap items-center gap-1.5">
                    ...
                    {m.requires_certification && (
                      <span className="rounded-full px-2 py-0.5 text-[10px] font-black" style={{ background: SOFT, color: PLUM }}>
