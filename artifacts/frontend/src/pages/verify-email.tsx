...
export default function VerifyEmail() {
  ...
  return (
    <div className="mx-auto flex min-h-[70vh] max-w-2xl items-center justify-center">
      <section className="w-full rounded-[2rem] border border-[#E5E7EB] bg-white p-8 text-center shadow-sm">
        <div className="mx-auto flex h-16 w-16 items-center justify-center rounded-full bg-[#F8F8FE] text-[#3730A3]">
          <Mail className="h-8 w-8" />
        </div>
        <h1 className="mt-5 text-3xl font-black tracking-tight" style={{ color: PLUM }}>
        ...
        <div className="mt-6 flex flex-col justify-center gap-3 sm:flex-row">
          <Button onClick={resend} disabled={busy} className="gap-2 rounded-xl" style={{ background: PLUM }}>
        ...
        <button
          type="button"
          onClick={logout}
          className="mt-5 inline-flex items-center gap-1 text-xs font-bold text-[#6B7280]"
        >
