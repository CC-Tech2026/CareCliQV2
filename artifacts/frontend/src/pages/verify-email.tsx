...
export default function VerifyEmail() {
  ...
  return (
    <div className="mx-auto flex min-h-[70vh] max-w-2xl items-center justify-center">
      <section className="w-full rounded-[2rem] border border-cc-border bg-cc-surface p-8 text-center shadow-sm">
        <div className="mx-auto flex h-16 w-16 items-center justify-center rounded-full bg-cc-bg text-cc-plum">
          <Mail className="h-8 w-8" />
        </div>
        <h1 className="mt-5 text-3xl font-black tracking-tight" style={{ color: PLUM }}>Verify your email</h1>
        <p className="mx-auto mt-3 max-w-lg text-sm leading-6 text-cc-muted">
        ...
        <button
          type="button"
          onClick={logout}
          className="mt-5 inline-flex items-center gap-1 text-xs font-bold text-cc-muted"
        >
