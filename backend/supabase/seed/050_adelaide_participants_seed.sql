...
INSERT INTO public.patients (
    ...
    (
        ...
        'plan-managed', 'Plan-managed via My Plan Manager (Adelaide)',
    ...
    (
        ...
        'self-managed', 'Self-managed — Amelia coordinates invoices directly',
        'Multiple Sclerosis',
    ...
    (
        ...
        'NDIA-managed', 'NDIA-managed plan',
        'Cerebral Palsy',
    ...
    (
        ...
        'plan-managed', 'Plan-managed via Plan Partners Adelaide',
