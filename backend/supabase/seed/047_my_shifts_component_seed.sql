...
BEGIN
    ...
    [
      ...
      {"task_id":"default_medication","type":"default","label":"Medication Administration","description":"Assist with medication as per the Medication Administration Record.","completed":false,"completed_at":null,"checked_at":null,"evidence_status":null,"evidence_added_at":null,"evidence_ids":[],"has_photo":false,"has_voice":false,"has_text_notes":false,"note":"","context_note":"Due at 10:30.","order":3,"mandatory":true,"goal_id":"health_wellbeing","goal_title":"Health & Wellbeing","outcome_tip":"Medications taken as prescribed with no adverse reactions noted."},
