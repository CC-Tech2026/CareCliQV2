...
CREATE TABLE IF NOT EXISTS public.plan_meeting_sessions (
    ...
    coordinator_id UUID NOT NULL REFERENCES profiles(user_id) ON DELETE RESTRICT,
    participant_id UUID REFERENCES participants(id) ON DELETE SET NULL,  -- Resolved after Stage 1
